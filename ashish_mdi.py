...
col_spec_dict = {
    ...
    'MS_COL_SPEC': [(0, 11), (11, 12), (12, 25), (26, 30), (30, 35), (35, 45),
                    (55, 63), (63, 71), (71, 75), (75, 89), (89, 103), (103, 114), (114, 125), (125, 136), (138, 148)]
}
...
#     state_file_list = glob.glob("\\\\dnafiles1\sales\MCOps\Gov't Pgms\Medicaid\STATES\CLD\MDI Directory Structure\*\*\*\*\*\*.*")
    ...
    state_file_list = glob.glob("/NAS/MCOps/Gov't Pgms/Medicaid/STATES/CLD/MDI Directory Structure/*/*/*/*/2025Q1/*.*")
...
def cld_standardize(df_map, cld_file, error_dict):
    ...
    try:
        ...
        for sheet, df in df_map.items():
            ...
            if cld_file.STATE == 'CT' :
                df['PROVIDER_ID_(NPI)'] = df['PROVIDER_ID_(NPI)'].str.replace('NPI ', '')
