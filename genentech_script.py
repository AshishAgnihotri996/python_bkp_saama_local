...
if os.path.isfile(curr_dir + r'\outputs\logs\\' + date.today().strftime("%Y%m%d") + '__validator.txt'):
    os.remove(curr_dir + r'\outputs\logs\\' + date.today().strftime("%Y%m%d") + '__validator.txt')
log_validation = open(curr_dir + r'\outputs\logs\\' + date.today().strftime("%Y%m%d") + '__validator.txt', 'a')
